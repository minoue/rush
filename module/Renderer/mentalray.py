...
if "Mayatomr" in cmds.pluginInfo(q=True, listPlugins=True):
    pass
else:
    raise ImportError
...
class Commands(object):
    ...
    commandDict['mib_glossy_reflection'] = '%s/render_mib_glossy_reflection.png' % iconPath

    def _mib_glossy_refraction(self):
        cmds.shadingNode('mib_glossy_refraction', asShader=True)
    commandDict['mib_glossy_refraction'] = '%s/render_mib_glossy_refraction.png' % iconPath

    def _mib_illum_blinn(self):
        cmds.shadingNode('mib_illum_blinn', asShader=True)
    commandDict['mib_illum_blinn'] = '%s/render_mib_illum_blinn.png' % iconPath

    def _mib_illum_cooktorr(self):
        cmds.shadingNode('mib_illum_cooktorr', asShader=True)
    commandDict['mib_illum_cooktorr'] = '%s/render_mib_illum_cooktorr.png' % iconPath

    def _mib_illum_lambert(self):
        cmds.shadingNode('mib_illum_lambert', asShader=True)
    commandDict['mib_illum_lambert'] = '%s/render_mib_illum_lambert.png' % iconPath

    def _mib_illum_phong(self):
        cmds.shadingNode('mib_illum_phong', asShader=True)
    commandDict['mib_illum_phong'] = '%s/render_mib_illum_phong.png' % iconPath

    def _mib_illum_ward(self):
        cmds.shadingNode('mib_illum_ward', asShader=True)
    commandDict['mib_illum_ward'] = '%s/render_mib_illum_ward.png' % iconPath

    def _mib_illum_ward_deriv(self):
        cmds.shadingNode('mib_illum_ward_deriv', asShader=True)
    commandDict['mib_illum_ward_deriv'] = '%s/render_mib_illum_ward_deriv.png' % iconPath
    ...
    commandDict['misss_call_shader'] = "%s/render_misss_call_shader.png" % iconPath
    ...
    commandDict['misss_fast_shader2'] = "render_unknown.png"
    ...
    commandDict['misss_mia_skin2_surface_phen'] = 'render_unknown.png'

    def _misss_physical(self):
        cmds.shadingNode('misss_physical', asShader=True)
    commandDict['misss_physical'] = '%s/render_misss_physical.png' % iconPath

    def _misss_set_normal(self):
        cmds.shadingNode('misss_set_normal', asShader=True)
    commandDict['misss_set_normal'] = '%s/render_misss_set_normal.png' % iconPath

    def _misss_skin_specular(self):
        cmds.shadingNode('misss_skin_specular', asShader=True)
    commandDict['misss_skin_specular'] = '%s/render_misss_skin_specular.png' % iconPath
    # SSS END

    def _path_material(self):
        cmds.shadingNode('path_material', asShader=True)
    commandDict['path_material'] = '%s/render_path_material.png' % iconPath

    def _transmat(self):
        cmds.shadingNode('transmat', asShader=True)
    commandDict['transmat'] = '%s/render_transmat.png' % iconPath

    def _mib_shadow_transparency(self):
        cmds.shadingNode('mib_shadow_transparency', asUtility=True)
    commandDict['mib_shadow_transparency'] = '%s/render_mib_shadow_transparency.png' % iconPath

    def _xgen_hair_phen(self):
        cmds.shadingNode('xgen_hair_phen', asShader=True)
    commandDict['xgen_hair_phen'] = 'commandButton.png'
